  ...
  >
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 175.216 175.552" aria-hidden="true">
      <defs>
        ...
        <filter id="whatsappBlur" width="1.115" height="1.114" x="-.057" y="-.057" color-interpolation-filters="sRGB">
...
<script setup>
// El número de WhatsApp debe ser reemplazado con el tuyo
// Formato: código de país + número (sin espacios ni guiones)
// Ejemplo: 34123456789 para España
</script>
